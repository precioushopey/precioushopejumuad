      ...
      <main className="bg-[#462317]/50 rounded-4xl backdrop-blur-xs border shadow-xs font-medium tracking-normal p-8 space-y-6">
        <section className="flex flex-col md:flex-row gap-6 animate-fade-in-delay-2">
          ...
          <article className="w-full md:w-1/2 space-y-4">
            ...
            <p>
              ...
              parents, neighbors, were mostly kind, warm, and supportive. They
              believed in me. They made me feel safe, smart, and seen. And while
              the world was far from perfect, it was simple enough to believe
              that if you tried your best, things would work out.
            </p>
          </article>
        </section>
        ...
        <section className="flex flex-col gap-6 animate-fade-in-delay-3">
          <article className="space-y-4">
            <p>
              ...
              important as being smart. Then there were my classmates. Chaotic,
              joyful, beautifully unpredictable. We were dreamers, pranksters,
        ...
        <section className="flex flex-col gap-6 animate-fade-in-delay-3">
          <article className="space-y-4">
            ...
            <p>
              And I’d reassure her of this, too: Even though our path to
              adulthood has been rocky, we’ve met incredible people along the
              way. People who helped carry the weight. I would tell her about
              the laughs and support we found with FAKULTO, the calm strength of
              a loving and understanding partner, the brilliance and unity of
              our thesis team, and classmates who showed up with sincerity and
              humor when we needed it most. These people made the climb
              bearable. They made it meaningful. And I’d tell her not to worry,
              we’ll find more people like them, maybe even better, as we go.
            </p>
          </article>
        </section>
        ...
        <section className="flex flex-col md:flex-row gap-6 animate-fade-in-delay-4">
          ...
          <article className="w-full md:w-1/2 space-y-4">
            <p>
              ...
              (Goleman, 1995). They shape our beliefs about self-worth, love,
              failure, and trust. And for those of us lucky enough to have had
              safe, meaningful childhoods, it becomes both a gift and a burden.
              Because every disappointment in adulthood feels like a betrayal of
              what we once believed. And every ache becomes sharper, because the
              child in us is still expecting a happy ending.
            </p>
            <p>
              According to a 2021 UNICEF report,{" "}
              <b>
                children who experience early emotional security tend to develop
                higher resilience in adulthood,
              </b>{" "}
              but they also{" "}
              <b>grieve harder when reality fails their expectations.</b>
              That explains the heaviness, the sadness I sometimes carry when I
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-6 animate-fade-in-delay-4">
          <figure className="space-y-4">
            ...
            />
            <figcaption>Fig.4 - My Elementary Graduation Photo</figcaption>
          </figure>
          <article className="space-y-4">
            <p>
          ...
          <figure className="space-y-4">
            ...
            />
            <figcaption>Fig.4 - My Pre-School Graduation Photo</figcaption>
          </figure>
        </section>
      </main>
